...
const string basePath = "data/chapter6/";
...
int main() {
    ...
    Mat LearnCV_black = imread(basePath + "LearnCV_black.png", IMREAD_ANYCOLOR);
    Mat LearnCV_write = imread(basePath + "LearnCV_write.png", IMREAD_ANYCOLOR);
    ...
    //验证腐蚀对小连通域的去除
    Mat img = imread(basePath + "rice.png");
    if (img.empty()) {
