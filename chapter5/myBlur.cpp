...
int main() {
    Mat equalLena = imread(basePath + "equalLena.png", IMREAD_ANYDEPTH);
    Mat equalLena_gauss = imread(basePath + "equalLena_gauss.png", IMREAD_ANYDEPTH);
    Mat equalLena_salt = imread(basePath + "equalLena_salt.png", IMREAD_ANYDEPTH);
