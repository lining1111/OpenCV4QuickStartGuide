...
//RANSAC算法实现
void ransac(vector<DMatch> matches, vector<KeyPoint> queryKeyPoint, vector<KeyPoint> trainKeyPoint,
...
const string basePath = "data/chapter9/";

int main() {
    Mat img1 = imread(basePath + "box.png");  //读取图像，根据图片所在位置填写路径即可
    Mat img2 = imread(basePath + "box_in_scene.png");
