...
int main() {
    Mat img = imread(basePath + "airplane.jpg");
    if (img.empty()) {
    ...
    //读取分类种类名称
    String typeListFile = basePath + "image_pattern/" + "imagenet_comp_graph_label_strings.txt";
    ...
    // 加载网络
    String tf_pb_file = basePath + "image_pattern/" + "tensorflow_inception_graph.pb";
